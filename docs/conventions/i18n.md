...
CMS-generated page URLs use `/{locale}/{alias}` format (no market). Our `stripGeinsPrefix()` utility handles this alongside the standard `/{market}/{locale}/{path}` format. See `local-docs/CMS-LANGUAGE-MODEL.md` for details.
