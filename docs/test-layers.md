...
| The tenant's own look | Theme colours reaching the page, the home page rendering, and the security policy the production build sets.                                                                                                                                                                   | `theme-colors` · `homepage` · `csp-policy`               |
| Edges                 | An unregistered hostname, plus the page basics: the tenant's own title, the header shape each viewport calls for, heading structure, the language attribute, console errors, load time.                                                                                        | `unknown-hostname` · `app`                               |
